#pragma once
#define ARRAY_OF_ERRORS_MAX_SIZE 5 //размер массива ошибок на каком то этапе
...
namespace Error
{
	...
	{
		ERROR arr_of_err[ARRAY_OF_ERRORS_MAX_SIZE];//массив ошибок
		int size = 0;                            //размер массива ошибок
	};
